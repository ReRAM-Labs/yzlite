...
set(TFLITE_MICRO_WRAPPER_DIR "${YZLITE_DIR}/core/tflite_micro" CACHE INTERNAL "")
...
set(TFLITE_MICRO_WRAPPER_IMPORT_LIB_PATH "${YZLITE_BINARY_DIR}/${TFLITE_MICRO_WRAPPER_FULLNAME}.a" CACHE INTERNAL "")
...
yzlite_get(TFLITE_MICRO_WRAPPER_ENABLE_DEBUG_SYMBOLS)
if("${CMAKE_BUILD_TYPE}" STREQUAL "Debug" OR TFLITE_MICRO_WRAPPER_ENABLE_DEBUG_SYMBOLS)
  ...
  yzlite_warn("Building wrapper with debug symbols")
else()
  yzlite_append_global_cxx_flags("-s")
  yzlite_info("Stripping debug symbols from wrapper")
...
if(HOST_OS_IS_WINDOWS)
  ...
  yzlite_append_global_cxx_flags("-fvisibility=hidden")
  yzlite_append_global_cxx_defines("YZLITE_DLL_EXPORT")
else()
  # Ensure all source files are built with the Position-Independent-Code (PIC) flag
  yzlite_append_global_cxx_flags("-fPIC")
  yzlite_platform_linux_link_legacy_glibc()
endif()


# Return the current GIT hash
# This will be embedded into the generated wrapper library
yzlite_git_hash(${CMAKE_CURRENT_LIST_DIR} YZLITE_GIT_HASH)
yzlite_info("Git hash: ${YZLITE_GIT_HASH}")
...
# lib_dir - Directory where shared library will reside in YZLITE
...
function(tflite_micro_link_python_wrapper target lib_dir)
  ...
  yzlite_append_global_cxx_defines("YZLITE_DLL_IMPORT")
  ...
  if(HOST_OS_IS_WINDOWS)
    ...
    yzlite_info("tflite_micro_archive_path: ${tflite_micro_archive_path}")
    yzlite_info("${CMAKE_GENDEF} ${TFLITE_MICRO_WRAPPER_PATH}")
    yzlite_info("${CMAKE_DLLTOOL} -k -d ${CMAKE_CURRENT_BINARY_DIR}/${fullname_no_ext}.def -l ${tflite_micro_archive_path}")
    add_custom_command( 
    ...
    yzlite_info("tflite_micro_wrapper relative directory: ${module_reldir}")
