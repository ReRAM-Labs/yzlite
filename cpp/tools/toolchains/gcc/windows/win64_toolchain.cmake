...
set(YZLITE_TOOLCHAIN_NAME windows CACHE INTERNAL "")
...
set(CMAKE_C_FLAGS_INIT   "-std=gnu11 -fdata-sections -ffunction-sections -m64 -fmacro-prefix-map=${CMAKE_SOURCE_DIR}/=/ -fmacro-prefix-map=${YZLITE_CPP_DIR}/=/" CACHE INTERNAL "c compiler flags")
set(CMAKE_CXX_FLAGS_INIT "-fdata-sections -ffunction-sections -m64 -fmacro-prefix-map=${CMAKE_SOURCE_DIR}/=/ -fmacro-prefix-map=${YZLITE_CPP_DIR}/=/" CACHE INTERNAL "cxx compiler flags")
...
macro(yzlite_toolchain_add_exe_targets target)
  ...
  add_custom_command(TARGET ${target}
    POST_BUILD
    COMMAND ${PYTHON_EXECUTABLE} ${YZLITE_CPP_DIR}/tools/utils/update_launch_json.py --name ${target} --path \"${_output_path}\" --toolchain \"${TOOLCHAIN_DIR}/bin\" --platform windows --workspace \"${CMAKE_SOURCE_DIR}\"
