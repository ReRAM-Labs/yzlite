...
set(YZLITE_TOOLCHAIN_NAME linux CACHE INTERNAL "")
...
set(CMAKE_C_FLAGS_INIT   "-std=gnu11 -fdata-sections -ffunction-sections -Wno-main -m64 -fmacro-prefix-map=${CMAKE_SOURCE_DIR}/=/ -fmacro-prefix-map=${YZLITE_CPP_DIR}/=/" CACHE INTERNAL "c compiler flags")
set(CMAKE_CXX_FLAGS_INIT "-fdata-sections -ffunction-sections -Wno-main -m64 -fmacro-prefix-map=${CMAKE_SOURCE_DIR}/=/ -fmacro-prefix-map=${YZLITE_CPP_DIR}/=/" CACHE INTERNAL "cxx compiler flags")
...
macro(yzlite_toolchain_add_exe_targets target)
  ...
  add_custom_command(TARGET ${target}
    POST_BUILD
    COMMAND ${PYTHON_EXECUTABLE} ${YZLITE_CPP_DIR}/tools/utils/update_launch_json.py --name ${target} --path \"${_output_path}\" --platform ${YZLITE_PLATFORM_NAME} --workspace \"${CMAKE_SOURCE_DIR}\"
    COMMAND ${CMAKE_SIZE} ${_output_path}
    COMMENT "Application ${target} binary size"
  )

  yzlite_warn("Statically linking exe, adding ld flags: static-libgcc -static-libstdc++ -pthread -static")
  target_link_options(${target}
  PUBLIC
