...
extern yzlite::StringList SL_TFLITE_MODEL_CLASSES;
extern yzlite::Int32List SL_TFLITE_DETECTION_THRESHOLD_LIST;
...
// <i> between two classification divided by the duration between the two
// results <i> is larger than this value then the activity indicator is enabled.
// <i> Default: 0.5
