...
public:
  ...
  enum class Mode { normal, saveFingerprints, iterateUsers, eraseSignatures };
  ...
  bool button_is_pressed(const sl_button_t *handle, uint32_t &active_timestamp,
                         unsigned min_time_ms, unsigned max_time_ms,
