/* Copyright 2017 The TensorFlow Authors. All Rights Reserved.
   ...
   This file has been modified by Yizhu Technology.
   ==============================================================================*/
...
RecognizeCommands::RecognizeCommands(int32_t average_window_duration_ms,
    ...
    : average_window_duration_ms_(average_window_duration_ms),
      ...
      suppression_count_(suppression_count), minimum_count_(minimum_count),
...
TfLiteStatus RecognizeCommands::ProcessLatestResults(
    const yzlite::TfliteTensorView *latest_results,
    const int32_t current_time_ms, uint8_t *found_command_index, uint8_t *score,
    bool *is_new_command) {
  ...
  if ((how_many_results < minimum_count_)) {
    ...
    if (consecutive_min_count % 10 == 0) {
      printf("Too few samples for averaging. This likely means the inference "
             "loop is taking too long.\n");
      printf("Either decrease the 'minimum_count' and/or increase "
