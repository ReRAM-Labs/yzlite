...
var buttonBlinkState = false

function blinkButtons() {
    buttonBlinkState = !buttonBlinkState
    if (buttonBlinkState) {
        $('.buttons').children().addClass('button-yo')
    } else {
        $('.buttons').children().removeClass('button-yo')
    }
}
...
function message(m) {
    $('#message').html(m)
    if (m === 'game over') $('#message').addClass('bule')
}
function clearMessage() {
    $('#message').html('')
    $('#message').removeClass('bule')
}
