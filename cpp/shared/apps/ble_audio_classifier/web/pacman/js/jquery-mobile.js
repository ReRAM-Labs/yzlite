...
;(function (root, doc, factory) {
                        ...
                        widgetOptions =
                            $.mobile.toolbar && theElement.data('mobile-toolbar')
                                ...
                                : {
                                      ...
                                      updatePagePadding:
                                          theElement.attr('data-' + $.mobile.ns + 'update-page-padding') !== false
                                  }
        ...
        $.extend($.mobile, {
            ...
            removeActiveLinkClass: function (forceRemoval) {
                if (
                    ...
                    (!$.mobile.activeClickedLink.closest('.' + $.mobile.activePageClass).length || forceRemoval)
                ) {
    ...
    ;(function ($) {
        ...
        $.widget('mobile.loader', {
            ...
            defaultHtml:
                "<div class='" + loaderClass + "'>" + "<span class='ui-icon-loading'></span>" + '<h1></h1>' + '</div>',
            ...
            fakeFixLoader: function () {
                ...
                this.element.css({
                    top:
                        ($.support.scrollTop && this.window.scrollTop() + this.window.height() / 2) ||
  ...
  */
    ...
    ;(function ($, window, document, undefined) {
        ...
        function handleTouchMove(event) {
            ...
            didScroll =
                didScroll || Math.abs(t.pageX - startX) > moveThreshold || Math.abs(t.pageY - startY) > moveThreshold
                ...
                rewrite: function (href, page) {
                    ...
                    page.find(base.linkSelector).each(function (i, link) {
                        ...
                        thisUrl = thisUrl.replace(
                            theLocation.protocol + theLocation.doubleSlash + theLocation.host + theLocation.pathname,
                            ''
                        )
        ...
        $.widget('mobile.pagecontainer', {
            ...
            _find: function (absUrl) {
                ...
                page = this.element.children(
                    '[data-' + this._getNs() + "url='" + $.mobile.path.hashToSelector(dataUrl) + "']"
                )
            ...
            load: function (url, options) {
                ...
                if (
                    !($.mobile.allowCrossDomainPages || $.mobile.path.isSameDomain($.mobile.path.documentUrl, absUrl))
                ) {
                    deferred.reject(absUrl, settings)
                    return deferred.promise()
                }
    ...
    ;(function ($, undefined) {
        ...
        $.mobile._registerInternalEvents = function () {
            ...
            $.mobile.document.bind('click', function (event) {
                ...
                isExternal =
                    useDefaultUrlHandling ||
                    ($.mobile.path.isExternal(href) && !$.mobile.path.isPermittedCrossDomainRequest(documentUrl, href))
            ...
            target
                ...
                .each(function () {
                    ...
                    if ($.mobile.degradeInputs[type]) {
                        ...
                        repstr =
                            ' type="' + optType + '" data-' + $.mobile.ns + 'type="' + type + '"' + (hasType ? '' : '>')
                ...
                if (this.options.dialog) {
                    this.element.addClass('ui-dialog').wrapInner(
                        $('<div/>', {
                            ...
                            role: 'dialog',
                            class:
                                'ui-dialog-contain ui-overlay-shadow' + (this.options.corners ? ' ui-corner-all' : '')
                        })
                    )
                }
            },
            ...
            _handleVClickSubmit: function (event) {
                ...
                if ($target.length && !$target.jqmData('transition')) {
                    ...
                    attrs['data-' + $.mobile.ns + 'transition'] =
                        ($.mobile.navigate.history.getActive() || {})['transition'] || $.mobile.defaultDialogTransition
    ...
    ;(function ($, undefined) {
        ...
        $.widget('mobile.collapsible', {
            ...
            _applyOptions: function (options) {
                ...
                if (
                    !(opts.iconpos === undefined && opts.collapsedIcon === undefined && opts.expandedIcon === undefined)
                ) {
            ...
            $.extend(
                {
                    ...
                    _handleCollapsibleExpand: function (event) {
                        ...
                        if (
                            closestCollapsible.parent().is(":mobile-collapsibleset, :jqmData(role='collapsible-set')")
                        ) {
                            closestCollapsible
            ...
            $.extend(
                {
                    ...
                    _addThumbClasses: function (containers) {
                        ...
                        for (i = 0; i < len; i++) {
                            img = $(
                                this._findFirstElementByTagName(containers[i].firstChild, 'nextSibling', 'img', 'IMG')
                            )
                            if (img.length) {
                                $(
                            ...
                            if (create || item[0].className.search(/\bui-li-static\b|\bui-li-divider\b/) < 0) {
                                ...
                                if (a.length && a[0].className.search(/\bui-btn\b/) < 0 && !isDivider) {
                                    ...
                                    if (a.length > 1) {
                                        ...
                                        last = a.last()
                                        splittheme =
                                            getAttr(last[0], 'theme') || o.splitTheme || getAttr(item[0], 'theme', true)
                                        splitThemeClass = splittheme ? ' ui-btn-' + splittheme : ''
                                        spliticon = getAttr(last[0], 'icon') || getAttr(item[0], 'icon') || o.splitIcon
                                        altButtonClass =
                                            'ui-btn ui-btn-icon-notext ui-icon-' + spliticon + splitThemeClass
                    ...
                    _hasIcon: function () {
                        ...
                        if (controlgroupConstructor) {
                            controlgroup = this.element.closest(
                                ':mobile-controlgroup,' + controlgroupConstructor.prototype.initSelector
                            )
                        ...
                        flipswitch
                            .addClass(
                                'ui-flipswitch ui-shadow-inset ' +
                                    ...
                                    (options.wrapperClass ? options.wrapperClass : '') +
                                    ' ' +
                                    (element.is(':checked') || element.find('option').eq(1).is(':selected')
            ...
            $.extend(
                {
                    ...
                    _updateHighlight: function () {
                        var min = parseInt(
                                $.data(this._inputFirst.get(0), 'mobile-slider').handle.get(0).style.left,
                                10
                            ),
                            max = parseInt(
                                $.data(this._inputLast.get(0), 'mobile-slider').handle.get(0).style.left,
                                10
                            ),
                            width = max - min
    ...
    ;(function ($, undefined) {
        ...
        $.widget('mobile.selectmenu', $.mobile.selectmenu, {
            ...
            build: function () {
                ...
                listbox = $(
                    '<div' + themeAttr + overlayThemeAttr + " id='" + popupId + "' class='ui-selectmenu'></div>"
                )
                ...
                header = $("<div class='ui-header ui-bar-" + (o.theme ? o.theme : 'inherit') + "'></div>").prependTo(
                    listbox
                )
                ...
                if (this._origTabIndex === undefined) {
                    ...
                    // none present.
                    this._origTabIndex =
                        this.select[0].getAttribute('tabindex') === null ? false : this.select.attr('tabindex')
                }
            ...
            $.extend(
                {
                    ...
                    _setOptions: function (options) {
                        ...
                        if (options.type !== undefined) {
                            elem.removeClass('ui-controlgroup-horizontal ui-controlgroup-vertical').addClass(
                                'ui-controlgroup-' + (options.type === 'horizontal' ? 'horizontal' : 'vertical')
                            )
                            callRefresh = true
                        }

                        if (options.theme !== undefined) {
                            elem.removeClass(this._themeClassFromOption(this.options.theme)).addClass(
    ...
    ;(function ($, undefined) {
        $.widget('mobile.toolbar', {
            ...
            _addHeaderButtonClasses: function () {
                ...
                this.leftbtn =
                    this.leftbtn ||
                    headerAnchors.eq(0).not('.ui-btn-right,.ui-toolbar-back-btn').addClass('ui-btn-left').length
        ...
        $.widget('mobile.popup', $.mobile.popup, {
            ...
            _tryAnArrow: function (p, dir, desired, s, best) {
                ...
                tip[p.snd] = Math.max(
                    ...
                    Math.min(
                        result[p.prop] + s.guideOffset[p.prop] + s.guideDims[p.dimKey] - s.arHalf[p.dimKey],
                        desired[p.snd]
                    )
                )
        ...
        $.widget('mobile.panel', {
                        ...
                        _openPanel = function () {
                            ...
                            if (o.theme && o.display !== 'overlay') {
                                self._page()
                                    .parent()
                                    .addClass(
                                        o.classes.pageContainer + '-themed ' + o.classes.pageContainer + '-' + o.theme
                                    )
                            }
                            ...
                            self._modalOpenClasses =
                                self._getPosDisplayClasses(o.classes.modal) + ' ' + o.classes.modalOpen
                            if (self._modal) {
                                self._modal
            ...
            _destroy: function () {
                var otherPanels,
                    o = this.options,
                    multiplePanels =
                        $('body > :mobile-panel').length + $.mobile.activePage.find(':mobile-panel').length > 1
