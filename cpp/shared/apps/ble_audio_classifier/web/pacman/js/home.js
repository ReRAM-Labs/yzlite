...
function resetHomeState() {
    ...
    PACMAN_TRAILER_CANVAS_CONTEXT = null
    PACMAN_TRAILER_DIRECTION = 3
    PACMAN_TRAILER_POSITION_X = 600
    PACMAN_TRAILER_POSITION_Y = 25
    PACMAN_TRAILER_POSITION_STEP = 3
    PACMAN_TRAILER_MOUNTH_STATE = 3
    PACMAN_TRAILER_MOUNTH_STATE_MAX = 6
    PACMAN_TRAILER_SIZE = 16

    GHOST_TRAILER_CANVAS_CONTEXT = null
    GHOST_TRAILER_BODY_STATE_MAX = 6
    GHOST_TRAILER_POSITION_STEP = 3

    GHOST_BLINKY_TRAILER_POSITION_X = 1000
    GHOST_BLINKY_TRAILER_POSITION_Y = 25
    GHOST_BLINKY_TRAILER_DIRECTION = 3
    GHOST_BLINKY_TRAILER_COLOR = '#ed1b24'
    GHOST_BLINKY_TRAILER_BODY_STATE = 0
    GHOST_BLINKY_TRAILER_STATE = 0

    GHOST_PINKY_TRAILER_POSITION_X = 1035
    GHOST_PINKY_TRAILER_POSITION_Y = 25
    GHOST_PINKY_TRAILER_DIRECTION = 3
    GHOST_PINKY_TRAILER_COLOR = '#feaec9'
    GHOST_PINKY_TRAILER_BODY_STATE = 1
    GHOST_PINKY_TRAILER_STATE = 0

    GHOST_INKY_TRAILER_POSITION_X = 1070
    GHOST_INKY_TRAILER_POSITION_Y = 25
    GHOST_INKY_TRAILER_DIRECTION = 3
    GHOST_INKY_TRAILER_COLOR = '#4adecb'
    GHOST_INKY_TRAILER_BODY_STATE = 2
    GHOST_INKY_TRAILER_STATE = 0

    GHOST_CLYDE_TRAILER_POSITION_X = 1105
    GHOST_CLYDE_TRAILER_POSITION_Y = 25
    GHOST_CLYDE_TRAILER_DIRECTION = 3
    GHOST_CLYDE_TRAILER_COLOR = '#f99c00'
    GHOST_CLYDE_TRAILER_BODY_STATE = 3
