...
extern "C" void ble_audio_classifier_init(void) {
  ...
  printf("NOTE: Audio classification will start when a bluetooth client "
         "connects\n");

  xTaskCreateStatic(audio_classifier_task, "audio_classifier", TASK_STACK_SIZE,
                    NULL, TASK_PRIORITY, task_stack, &task_handle);
}
...
/***************************************************************************/ /**
                                                                               ...
                                                                               ******************************************************************************/
extern "C" void ble_audio_classifier_set_detection_callback(
    BleAudioClassifierDetectionCallback callback) {
