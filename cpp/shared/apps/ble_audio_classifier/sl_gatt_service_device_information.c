...
void sl_gatt_service_device_information_on_event(sl_bt_msg_t *evt) {
  ...
  case sl_bt_evt_system_boot_id:
    ...
    sc = sl_bt_gatt_server_write_attribute_value(gattdb_model_number_string, 0,
...
//  GATT Configurator to set the value manually.
    ...
    sc = sl_bt_gatt_server_write_attribute_value(
        gattdb_hardware_revision_string, 0, GATTDB_HARDWARE_REVISION_STRING_LEN,
...
//  GATT Configurator to set the value manually.
    ...
    sc = sl_bt_gatt_server_write_attribute_value(
        gattdb_firmware_revision_string, 0, GATTDB_FIRMWARE_REVISION_STRING_LEN,
