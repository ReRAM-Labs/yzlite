...
GATT_DATA(const uint16_t gattdb_uuidtable_16_map[]) = {
    0x2800, 0x2801, 0x2803, 0x2a00, 0x2a01, 0x2a29,
    0x2a23, 0x2a05, 0x2b2a, 0x2b29, 0x2902,
};

GATT_DATA(const uint8_t gattdb_uuidtable_128_map[]) = {
    0x4e, 0x3e, 0xce, 0x3f, 0x14, 0xec, 0x6c, 0x8f,
    0xb9, 0x46, 0xd4, 0x4e, 0x91, 0xfe, 0x0f, 0xc2,
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_18) = {.len = 16,
                                                                    .data = {
                                                                        0x4e,
                                                                        0x3e,
                                                                        0xce,
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_10) = {.len = 14,
                                                                    .data = {
                                                                        0x4d,
                                                                        0x4c,
                                                                        0x54,
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
    ...
    {.handle = 0x02,
     ...
     .state = 0x00,
     .datatype = 0x05,
     .characteristic = {.properties = 0x20, .char_uuid = 0x0007}},
    {.handle = 0x03,
     .uuid = 0x0007,
     .permissions = 0x800,
     .caps = 0xffff,
    ...
    {.handle = 0x05,
     ...
     .state = 0x00,
     .datatype = 0x05,
     .characteristic = {.properties = 0x02, .char_uuid = 0x0008}},
    {.handle = 0x06,
     .uuid = 0x0008,
     .permissions = 0x801,
     .caps = 0xffff,
    ...
    {.handle = 0x07,
     ...
     .state = 0x00,
     .datatype = 0x05,
     .characteristic = {.properties = 0x0a, .char_uuid = 0x0009}},
    {.handle = 0x08,
     .uuid = 0x0009,
     .permissions = 0x803,
     .caps = 0xffff,
    ...
    {.handle = 0x0a,
     ...
     .state = 0x00,
     .datatype = 0x05,
     .characteristic = {.properties = 0x02, .char_uuid = 0x0003}},
    {.handle = 0x0b,
     .uuid = 0x0003,
     .permissions = 0x801,
     .caps = 0xffff,
     .state = 0x00,
     .datatype = 0x00,
     .constdata = &gattdb_attribute_field_10},
    {.handle = 0x0c,
     .uuid = 0x0002,
     .permissions = 0x801,
     .caps = 0xffff,
    ...
    {.handle = 0x12,
     ...
     .state = 0x00,
     .datatype = 0x01,
     .dynamicdata = &gattdb_attribute_field_17},
    {.handle = 0x13,
     .uuid = 0x0000,
     .permissions = 0x8801,
     .caps = 0xffff,
     .state = 0x00,
     .datatype = 0x00,
     .constdata = &gattdb_attribute_field_18},
    {.handle = 0x14,
     .uuid = 0x0002,
     .permissions = 0x801,
     .caps = 0xffff,
     .state = 0x00,
     .datatype = 0x05,
     .characteristic = {.properties = 0x1a, .char_uuid = 0x8000}},
    {.handle = 0x15,
     .uuid = 0x8000,
     .permissions = 0x803,
     .caps = 0xffff,
     .state = 0x00,
     .datatype = 0x01,
     .dynamicdata = &gattdb_attribute_field_20},
    {.handle = 0x16,
     .uuid = 0x000a,
     .permissions = 0x803,
     .caps = 0xffff,
