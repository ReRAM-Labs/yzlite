...
enum class Level : uint8_t { Debug, Info, Warn, Error, Disabled, Count };
...
Logger *create(const char *tag, Level level = Level::Info,
...
void dump_hex(const char *tag, const void *address, unsigned length,
