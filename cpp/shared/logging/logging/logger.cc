...
/*************************************************************************************************/
bool Logger::level_is_enabled(Level level) const { return level >= _level; }
...
/*************************************************************************************************/
const Writer &Logger::writer() const { return _writer; }
...
/*************************************************************************************************/
void Logger::vdump_hex(const void *address, unsigned length, const char *desc,
                       va_list args) {
  int i;
  uint8_t buff[17];
...
void Logger::vwrite(Level level, const char *fmt, va_list args) const {
  if ((_writer != nullptr) && (_level != Level::Disabled) &&
      (level >= _level)) {
...
void Logger::write_buffer(Level level, const char *buffer, int length) const {
  if ((_writer != nullptr) && (_level != Level::Disabled) &&
    ...
    const int prefix_len =
        write_prefix(level, prefix_buffer, sizeof(prefix_buffer));
...
/*************************************************************************************************/
int Logger::write_prefix(Level level, char *buffer,
