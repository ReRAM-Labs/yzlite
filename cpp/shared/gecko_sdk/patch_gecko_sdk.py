...
def process_startup_file(lineno: int, line: str, arg: object) -> str:
    ...
    if arg['state'] == 0 and line.strip() == 'void Default_Handler(void)':
        ...
        line += '#  if __has_include ("yzlite_fault_handler.h")\n'
        line += '#    include "yzlite_fault_handler.h"\n'
        line += '#  endif\n'
        line += '#endif\n'
        line += '#ifndef YZLITE_ADD_FAULT_HANDLER\n'
        line += '#define YZLITE_ADD_FAULT_HANDLER() while (true){}\n'
        line += '#endif\n\n'
