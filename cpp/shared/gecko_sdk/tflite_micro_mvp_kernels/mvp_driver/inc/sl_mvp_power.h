 ...
 *
 * @details
 *   This function is used internally to prepare the MVP for loading a MVP
 * program. Preparing for execution involves waiting for the MVP to finish
 * execution of the currently running program. The SL_MVP_POWER_MODE
 * configuration will control how this function behaves.
 */
