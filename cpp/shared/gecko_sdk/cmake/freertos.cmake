...
set(NAME "yzlite_reram_sdk_freertos")
add_library(${NAME})
add_library(yzlite::reram_sdk::freertos ALIAS ${NAME})
...
if(NOT CMSIS_CORE)
    yzlite_error("Must specify CMSIS_CORE global property")
endif()
...
PRIVATE
    ...
    kernel/portable/YizhuTech/tick_power_manager.c
...
elseif(CMSIS_CORE STREQUAL "cortex-m4")
    ...
    yzlite_debug("GSDK FreeRTOS: CMSIS_CORE unsupported: ${CMSIS_CORE}")
endif()
