set(NAME "yzlite_reram_sdk_mx25_flash_shutdown")
add_library(${NAME}_eusart)
add_library(yzlite::reram_sdk::mx25_flash_shutdown_eusart ALIAS ${NAME}_eusart)
add_library(${NAME}_usart)
add_library(yzlite::reram_sdk::mx25_flash_shutdown_usart ALIAS ${NAME}_usart)
