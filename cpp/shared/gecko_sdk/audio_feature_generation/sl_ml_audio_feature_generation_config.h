...
// <o SL_ML_AUDIO_FEATURE_GENERATION_AUDIO_BUFFER_SIZE> Audio Buffer Size
// <1024-16384:512> <i> Sets the length of the audio buffer in bytes. The audio
// buffer must <i> be large enough to store all new data between calls to <i>
// sl_ml_audio_feature_generation_update_features(). <i> Note: Length must be a
// multiple of 512 <i> Default: 1024
...
// <q SL_ML_AUDIO_FEATURE_GENERATION_MANUAL_CONFIG_ENABLE> Enable Manual
// Frontend Configurations <i> Enable manual configuration of the Frontend <i>
// This may overwrite settings that are already embedded in <i> a .tflite file.
// <i> Default: 0
...
// Use frontend configurations from tflite model file in
// sl_tflite_micro_model_parameters.h
...
#define SL_ML_FRONTEND_FILTERBANK_N_CHANNELS                                   \
  SL_TFLITE_MODEL_FE_FILTERBANK_N_CHANNELS
#define SL_ML_FRONTEND_FILTERBANK_LOWER_BAND_LIMIT                             \
  SL_TFLITE_MODEL_FE_FILTERBANK_LOWER_BAND_LIMIT
#define SL_ML_FRONTEND_FILTERBANK_UPPER_BAND_LIMIT                             \
  SL_TFLITE_MODEL_FE_FILTERBANK_UPPER_BAND_LIMIT
#define SL_ML_FRONTEND_NOISE_REDUCTION_ENABLE                                  \
  SL_TFLITE_MODEL_FE_NOISE_REDUCTION_ENABLE
#define SL_ML_FRONTEND_NOISE_REDUCTION_SMOOTHING_BITS                          \
  SL_TFLITE_MODEL_FE_NOISE_REDUCTION_SMOOTHING_BITS
#define SL_ML_FRONTEND_NOISE_REDUCTION_EVEN_SMOOTHING                          \
  SL_TFLITE_MODEL_FE_NOISE_REDUCTION_EVEN_SMOOTHING
#define SL_ML_FRONTEND_NOISE_REDUCTION_ODD_SMOOTHING                           \
  SL_TFLITE_MODEL_FE_NOISE_REDUCTION_ODD_SMOOTHING
#define SL_ML_FRONTEND_NOISE_REDUCTION_MIN_SIGNAL_REMAINING                    \
  SL_TFLITE_MODEL_FE_NOISE_REDUCTION_MIN_SIGNAL_REMAINING
...
#define SL_ML_FRONTEND_ACTIVITY_DETECTION_ENABLE                               \
  SL_TFLITE_MODEL_FE_ACTIVITY_DETECTION_ENABLE
#define SL_ML_FRONTEND_ACTIVITY_DETECTION_ALPHA_A                              \
  SL_TFLITE_MODEL_FE_ACTIVITY_DETECTION_ALPHA_A
#define SL_ML_FRONTEND_ACTIVITY_DETECTION_ALPHA_B                              \
  SL_TFLITE_MODEL_FE_ACTIVITY_DETECTION_ALPHA_B
#define SL_ML_FRONTEND_ACTIVITY_DETECTION_ARM_THRESHOLD                        \
  SL_TFLITE_MODEL_FE_ACTIVITY_DETECTION_ARM_THRESHOLD
#define SL_ML_FRONTEND_ACTIVITY_DETECTION_TRIP_THRESHOLD                       \
  SL_TFLITE_MODEL_FE_ACTIVITY_DETECTION_TRIP_THRESHOLD
#define SL_ML_FRONTEND_DC_NOTCH_FILTER_ENABLE                                  \
  SL_TFLITE_MODEL_FE_DC_NOTCH_FILTER_ENABLE
#define SL_ML_FRONTEND_DC_NOTCH_FILTER_COEFFICIENT                             \
  SL_TFLITE_MODEL_FE_DC_NOTCH_FILTER_COEFFICIENT
...
#define SL_ML_AUDIO_FEATURE_GENERATION_QUANTIZE_DYNAMIC_SCALE_ENABLE           \
  SL_TFLITE_MODEL_FE_QUANTIZE_DYNAMIC_SCALE_ENABLE
#define SL_ML_AUDIO_FEATURE_GENERATION_QUANTIZE_DYNAMIC_SCALE_RANGE_DB         \
  SL_TFLITE_MODEL_FE_QUANTIZE_DYNAMIC_SCALE_RANGE_DB

#define SL_ML_AUDIO_FEATURE_GENERATION_SAMPLEWISE_NORM_RESCALE                 \
  SL_TFLITE_MODEL_SAMPLEWISE_NORM_RESCALE
#define SL_ML_AUDIO_FEATURE_GENERATION_SAMPLEWISE_NORM_MEAN_AND_STD            \
  SL_TFLITE_MODEL_SAMPLEWISE_NORM_MEAN_AND_STD
...
bool yzlite_sl_ml_audio_feature_generation_load_parameters(
