...
void print_metrics(const char *name, logging::Logger *logger = nullptr,
                   bool pretty_print = true);
void print_metrics(const Profiler *profiler, logging::Logger *logger = nullptr,
                   bool pretty_print = true);
void print_stats(const char *name, logging::Logger *logger = nullptr,
                 bool pretty_print = true);
void print_stats(const Profiler *profiler, logging::Logger *logger = nullptr,
                 bool pretty_print = true);
