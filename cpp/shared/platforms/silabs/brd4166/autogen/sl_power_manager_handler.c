...
/***************************************************************************/ /**
                                                                               ...
                                                                               *        re-enabled.
                                                                               ******************************************************************************/
__WEAK bool app_is_ok_to_sleep(void) { return true; }
...
bool sl_power_manager_sleep_on_isr_exit(void) {
  ...
  // This function allow the power manager to return into sleep, if the latest
  // timer to expire was power manager's internal one used to restore HFXO on
  // time or the HFXO interrupt. Most of the time we want to get back to sleep
