...
// HASH module
#if !defined(PSA_WANT_ALG_SHA_1) && !defined(PSA_WANT_ALG_SHA_224) &&          \
    !defined(PSA_WANT_ALG_SHA_256) && !defined(PSA_WANT_ALG_SHA_384) &&        \
    !defined(PSA_WANT_ALG_SHA_512) && !defined(PSA_WANT_ALG_MD5)
...
#if !defined(PSA_WANT_ALG_ECDSA) && !defined(PSA_WANT_ALG_EDDSA) &&            \
    !defined(PSA_WANT_ALG_DETERMINISTIC_ECDSA)
#define TFM_CRYPTO_ASYM_SIGN_MODULE_DISABLED
#endif

// Cipher module
#if !defined(PSA_WANT_ALG_CFB) && !defined(PSA_WANT_ALG_CTR) &&                \
    !defined(PSA_WANT_ALG_CBC_NO_PADDING) &&                                   \
    !defined(PSA_WANT_ALG_CBC_PKCS7) &&                                        \
    !defined(PSA_WANT_ALG_ECB_NO_PADDING) && !defined(PSA_WANT_ALG_XTS) &&     \
...
#if !defined(PSA_WANT_ALG_PBKDF2_HMAC) && !defined(PSA_WANT_ALG_HKDF) &&       \
    !defined(PSA_WANT_ALG_PBKDF2_AES_CMAC_PRF_128) &&                          \
    !defined(PSA_WANT_ALG_TLS12_PRF) &&                                        \
    !defined(PSA_WANT_ALG_TLS12_PSK_TO_MS) && !defined(PSA_WANT_ALG_ECDH)
