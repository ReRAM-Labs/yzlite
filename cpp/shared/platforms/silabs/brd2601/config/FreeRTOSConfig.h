...
//  required when stack checking is enabled. <i> Default: 2
...
//  semaphore structures and display associated text names. <i> Default: 10
...
#define configNUM_THREAD_LOCAL_STORAGE_POINTERS                                \
  (configNUM_USER_THREAD_LOCAL_STORAGE_POINTERS +                              \
