...
static const reg_addr_value_t ov2640_default_regs[] = {
    ...
    {0x54, 0x00}, {0x55, 0x00},
    {0x5A, 0x2c}, {0x5b, 0x24},
    {0x5c, 0x00}, {REG_ADDR_ACTION, REG_ACTION_TERMINATE},
};
...
static const uint8_t
    ov2640_special_effect_regs[ARDUCAM_SPECIALEFFECT_COUNT + 1][5] = {
        {BPADDR, BPDATA, BPADDR, BPDATA, BPDATA},
...
static const reg_addr_value_t ov2640_jpeg_regs[] = {
    ...
    {0xFF, 0x01}, {0x04, 0x08}, {REG_ADDR_ACTION, REG_ACTION_TERMINATE},
};
...
static const reg_addr_value_t ov2640_cif[] = {
    ...
    {0x57, 0x00}, {0x5a, 0x58},
    {0x5b, 0x48}, {0x5c, 0x00},
    {0xe0, 0x00}, {REG_ADDR_ACTION, REG_ACTION_TERMINATE},
};
