...
static int allocate_larger_buffer(dynamic_buffer_t *buffer,
...
/*************************************************************************************************/
int dynamic_buffer_realloc(dynamic_buffer_t *buffer,
                           uint32_t additional_length) {
  int result = 0;
  ...
  if (remaining_len < additional_length) {
    ...
    const uint32_t new_length =
        dynamic_buffer_get_total_size(buffer) + additional_length;
    ...
    const uint32_t prepend_offset =
        (uint32_t)(buffer->prepend - buffer->buffer);
...
int dynamic_buffer_copy(dynamic_buffer_t *dst, const dynamic_buffer_t *src) {
  return dynamic_buffer_write(dst, src->prepend,
                              dynamic_buffer_get_length(src));
}
...
/*************************************************************************************************/
int dynamic_buffer_write(dynamic_buffer_t *buffer, const void *data,
...
/*************************************************************************************************/
int dynamic_buffer_vwrite(dynamic_buffer_t *buffer, const char *fmt,
                          va_list args) {
  int length = 0;
...
/*************************************************************************************************/
int dynamic_buffer_get_buffer(const dynamic_buffer_t *dynamic_buffer,
                              uint8_t **buffer_ptr, uint32_t *length_ptr) {
...
/*************************************************************************************************/
int dynamic_buffer_adjust_data_end(dynamic_buffer_t *buffer,
                                   int32_t adjust_amount) {
  if ((buffer->append + adjust_amount < buffer->buffer) ||
      (buffer->append + adjust_amount > buffer->buffer_end)) {
    return -1;
  } else {
...
/*************************************************************************************************/
int dynamic_buffer_adjust_data_start(dynamic_buffer_t *buffer,
                                     int32_t adjust_amount) {
  if ((buffer->prepend + adjust_amount < buffer->buffer) ||
      (buffer->prepend + adjust_amount > buffer->buffer_end)) {
    return -1;
  } else {
...
static int allocate_larger_buffer(dynamic_buffer_t *buffer,
  ...
  const uint32_t alloc_chunk_size =
      MAX(ALIGN_n(additional_length, 128), alloc_size / 2);
