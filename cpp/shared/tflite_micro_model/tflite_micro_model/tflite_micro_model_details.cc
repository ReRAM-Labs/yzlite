...
/*************************************************************************************************/
bool TfliteMicroModelDetails::load_parameters(
    const TfliteModelParameters *params) {
  unload();
...
/*************************************************************************************************/
const char *TfliteMicroModelDetails::name() const { return _name ? _name : ""; }
...
/*************************************************************************************************/
const char *TfliteMicroModelDetails::date() const { return _date ? _date : ""; }

/*************************************************************************************************/
unsigned TfliteMicroModelDetails::version() const { return _version; }
...
/*************************************************************************************************/
const StringList &TfliteMicroModelDetails::classes() const { return _classes; }

/*************************************************************************************************/
const char *TfliteMicroModelDetails::hash() const { return _hash ? _hash : ""; }
