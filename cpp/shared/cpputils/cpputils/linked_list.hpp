...
struct LinkedListIterator {
  ...
  void *operator*() { return (current == nullptr) ? nullptr : current; }
...
public:
  ...
  constexpr LinkedListItem *list(void) const { return head_; }

  template <typename T> constexpr T *list(void) const {
  ...
  LinkedListIterator begin(void) const { return LinkedListIterator(head_); }
