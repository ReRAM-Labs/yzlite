...
/*************************************************************************************************/
bool Dict::put(const char *key, const void *value, uint32_t length,
               bool unique) {
  ...
  uint8_t *ptr = static_cast<uint8_t *>(
      malloc(sizeof(DictItem) + strlen(key) + 1 + length));
...
/*************************************************************************************************/
DictValueIterator::DictValueIterator(DictItem *head) : current(head){};
...
/*************************************************************************************************/
DictKeyIterator::DictKeyIterator(DictItem *head) : current(head){};
...
/*************************************************************************************************/
DictItemIterator::DictItemIterator(DictItem *head) : current(head){};
...
/*************************************************************************************************/
DictItem *DictItemIterator::operator*() { return current; }
