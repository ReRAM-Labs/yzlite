 ...
 *
 * This provides access to application parameters stored in a .tflite model
 * flatbuffer's metadata. Application parameters are things like audio sampling
 * rate, FFT bins, etc.
 *
 */
class TfliteModelParameters {
private:
  typedef const flatbuffers::Vector<flatbuffers::Offset<schema::Entry>>
      EntryVector;
  typedef flatbuffers::Vector<
      flatbuffers::Offset<schema::Entry>>::const_iterator EntryVectorIterator;
  typedef flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>
      StringVector;
  typedef flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>::
      const_iterator StringVectorIterator;
...
public:
  ...
  struct StringList {
    ...
    constexpr bool is_valid() const { return (vector != nullptr); }
  };
  ...
  static bool load_from_tflite_flatbuffer(const void *flatbuffer,
  ...
  constexpr bool is_loaded() const { return _fb_dictionary != nullptr; }
...
#define _MODEL_PARAMS_ADD_GETTER(_type)                                        \
  if (entry_type == schema::Value::_type) {                                    \
    ...
    return true;                                                               \
      ...
      else _MODEL_PARAMS_ADD_GETTER(i8) else _MODEL_PARAMS_ADD_GETTER(u8) else _MODEL_PARAMS_ADD_GETTER(i16) else _MODEL_PARAMS_ADD_GETTER(u16) else _MODEL_PARAMS_ADD_GETTER(
          i32) else _MODEL_PARAMS_ADD_GETTER(u32) else _MODEL_PARAMS_ADD_GETTER(i64) else _MODEL_PARAMS_ADD_GETTER(u64) else _MODEL_PARAMS_ADD_GETTER(f32) else _MODEL_PARAMS_ADD_GETTER(f64)
