...
bool TfliteModelParameters::load_from_tflite_flatbuffer(
    const void *flatbuffer, TfliteModelParameters &parameters) {
  const void *metadata = get_metadata_from_tflite_flatbuffer(
      flatbuffer, TfliteModelParameters::METADATA_TAG);
  if (metadata == nullptr) {
    return false;
  }
...
/*************************************************************************************************/
void TfliteModelParameters::unload() { _fb_dictionary = nullptr; }

/*************************************************************************************************/
TfliteModelParameters::TfliteModelParameters(
    const TfliteModelParameters &other) {
  load(other._fb_dictionary);
}

/*************************************************************************************************/
TfliteModelParameters &
TfliteModelParameters::operator=(const TfliteModelParameters &other) {
  load(other._fb_dictionary);
  return *this;
}

/*************************************************************************************************/
const TfliteModelParameters::Value *
TfliteModelParameters::get(const char *key) const {
...
/*************************************************************************************************/
const TfliteModelParameters::Value *
TfliteModelParameters::operator[](const char *key) const {
  return get(key);
}
...
/*************************************************************************************************/
bool TfliteModelParameters::get(const char *key, const uint8_t *&data,
...
/*************************************************************************************************/
const TfliteModelParameters::Value *
TfliteModelParameters::Iterator::operator*() {
  auto entry = *it;
  return reinterpret_cast<const Value *>(entry);
}

/*************************************************************************************************/
void TfliteModelParameters::Iterator::operator++() { ++it; }
...
TfliteModelParameters::StringList
TfliteModelParameters::Value::str_list(void) const {
  return StringList(value_as_str_list()->data());
}

TfliteModelParameters::Int32List
TfliteModelParameters::Value::int32_list(void) const {
  return Int32List(value_as_int32_list()->data());
}

TfliteModelParameters::FloatList
TfliteModelParameters::Value::float_list(void) const {
...
StringList::StringList(const StringList &other) { this->vector = other.vector; }
...
StringList::Iterator StringList::begin(void) const {
  return (vector != nullptr) ? StringList::Iterator(vector->begin())
                             : StringList::Iterator();
}

StringList::Iterator StringList::end(void) const {
  return (vector != nullptr) ? StringList::Iterator(vector->end())
                             : StringList::Iterator();
}

StringList::Iterator::Iterator(StringVectorIterator it) : it(it) {}

bool StringList::Iterator::operator!=(Iterator rhs) { return it != rhs.it; }
...
void StringList::Iterator::operator++() { ++it; }

Int32List::Int32List(const Int32Vector *vector) : vector(vector) {}

Int32List::Int32List(const Int32List &other) { this->vector = other.vector; }
...
Int32List::Iterator Int32List::begin(void) const {
  return (vector != nullptr) ? Int32List::Iterator(vector->begin())
                             : Int32List::Iterator();
}

Int32List::Iterator Int32List::end(void) const {
  return (vector != nullptr) ? Int32List::Iterator(vector->end())
                             : Int32List::Iterator();
}

Int32List::Iterator::Iterator(Int32VectorIterator it) : it(it) {}

bool Int32List::Iterator::operator!=(Iterator rhs) { return it != rhs.it; }

int32_t Int32List::Iterator::operator*() { return *it; }

void Int32List::Iterator::operator++() { ++it; }

FloatList::FloatList(const FloatVector *vector) : vector(vector) {}

FloatList::FloatList(const FloatList &other) { this->vector = other.vector; }
...
FloatList::Iterator FloatList::begin(void) const {
  return (vector != nullptr) ? FloatList::Iterator(vector->begin())
                             : FloatList::Iterator();
}

FloatList::Iterator FloatList::end(void) const {
  return (vector != nullptr) ? FloatList::Iterator(vector->end())
                             : FloatList::Iterator();
}

FloatList::Iterator::Iterator(FloatVectorIterator it) : it(it) {}

bool FloatList::Iterator::operator!=(Iterator rhs) { return it != rhs.it; }

float FloatList::Iterator::operator*() { return *it; }

void FloatList::Iterator::operator++() { ++it; }
