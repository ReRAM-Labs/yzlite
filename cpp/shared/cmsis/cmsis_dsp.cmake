...
add_library(yzlite_cmsis_dsp INTERFACE)
add_library(yzlite::cmsis_dsp ALIAS yzlite_cmsis_dsp)


add_subdirectory("${cmsis_dsp_SOURCE_DIR}/Source")

target_link_libraries(yzlite_cmsis_dsp
INTERFACE
    CMSISDSP
    yzlite_cmsis
)

target_compile_definitions(yzlite_cmsis_dsp
INTERFACE
...
add_custom_command(OUTPUT ${cmsis_dsp_SOURCE_DIR}/yzlite_cmsis_dsp_patch_complete.txt
  DEPENDS ${cmsis_dsp_SOURCE_DIR}/Include ${CMAKE_CURRENT_LIST_DIR}/patch_cmsis_dsp.py
  COMMAND ${PYTHON_EXECUTABLE} ${YZLITE_CPP_UTILS_DIR}/libpatcher.py -i "${cmsis_dsp_SOURCE_DIR}/Include" -p ${CMAKE_CURRENT_LIST_DIR}/patch_cmsis_dsp.py -o ${cmsis_dsp_SOURCE_DIR}/yzlite_cmsis_dsp_patch_complete.txt
)
add_custom_target(yzlite_cmsis_dsp_apply_patch DEPENDS ${cmsis_dsp_SOURCE_DIR}/yzlite_cmsis_dsp_patch_complete.txt)
add_dependencies(CMSISDSP yzlite_cmsis_dsp_apply_patch)