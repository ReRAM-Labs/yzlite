...
def AddSchemaVersion(builder, schemaVersion): builder.PrependUint8Slot(
    0, schemaVersion, 0)
...
def AddEntries(builder, entries): builder.PrependUOffsetTRelativeSlot(
