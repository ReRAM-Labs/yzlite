...
class AudioFeatureGeneratorSettings(dict):
    ...
    **Example Usage**
    ...
    .. code-block:: python
        ...
        from yzlite.core.preprocess.audio.audio_feature_generator import AudioFeatureGeneratorSettings
    ...
    def spectrogram_shape(self) -> Tuple[int, int]:
        ...
        window_size_length = int(
            (self.window_size_ms * self.sample_rate_hz) / 1000)
        window_step_length = int(
            (self.window_step_ms * self.sample_rate_hz) / 1000)
        height = (self.sample_length -
                  window_size_length) // window_step_length + 1
    ...
    def sample_length(self) -> int:
        ...
        """
        sample_length = int(
            (self.sample_length_ms * self.sample_rate_hz) / 1000)
