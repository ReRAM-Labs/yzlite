...
`Keyword Spotting Pac-Man <https://github.com/chenxingqiang/yzlite/yzlite/tutorials/keyword_spotting_pacman.html>`_ tutorial.


- Source code: `keyword_spotting_pacman_v3.py <https://github.com/chenxingqiang/yzlite/blob/master/yzlite/models/yizhutech/keyword_spotting_pacman_v3.py>`_
- Pre-trained model: `keyword_spotting_pacman_v3.yzlite.zip <https://github.com/chenxingqiang/yzlite/raw/master/yzlite/models/yizhutech/keyword_spotting_pacman_v3.yzlite.zip>`_
...
- `yzlite.datasets.audio.direction_commands <https://github.com/chenxingqiang/yzlite/docs/python_api/datasets/audio/direction_commands.html>`_ - Synthetically generated keywords: left, right, up, down, stop, go
- `yzlite.datasets.audio.speech_commands_v2 <https://github.com/chenxingqiang/yzlite/docs/python_api/datasets/audio/speech_commands_v2.html>`_ - Human generated keywords: left, right, up, down, stop, go
- `yzlite.datasets.audio.mlcommons.ml_commons_keyword <https://github.com/chenxingqiang/yzlite/docs/python_api/datasets/audio/ml_commons/keywords.html>`_ - Large collection of keywords, random subset used for *unknown* class
- `yzlite.datasets.audio.background_noise.esc50 <https://github.com/chenxingqiang/yzlite/docs/python_api/datasets/audio/background_noise/esc50.html>`_ - Collection of various noises, random subset used for *unknown* class
- `yzlite.datasets.audio.background_noise.ambient <https://github.com/chenxingqiang/yzlite/docs/python_api/datasets/audio/background_noise/ambient.html>`_ - Collection of various background noises, mixed into other samples for augmentation
- `yzlite.datasets.audio.background_noise.brd2601 <https://github.com/chenxingqiang/yzlite/docs/python_api/datasets/audio/background_noise/brd2601.html>`_ - "Silence" recorded by BRD2601 microphone, mixed into other samples to make them "sound" like they came from the BRD2601's microphone
...
The audio samples are converted to a spectrogram using the :py:class:`yzlite.core.preprocess.audio.audio_feature_generator.AudioFeatureGenerator`.
...
More details at `yzlite.models.shared.tenet.TENet <https://github.com/chenxingqiang/yzlite/docs/python_api/models/common_models.html#tenet>`_
...
.. code-block:: shell
    ...
    yzlite summarize keyword_spotting_pacman_v3 --tflite
...
.. code-block:: shell
   ...
   yzlite profile keyword_spotting_pacman_v3 --device --accelerator MVP
...
.. code-block:: shell
   ...
   yzlite view keyword_spotting_pacman_v3 --tflite
...
.. code-block:: shell
   ...
   yzlite train keyword_spotting_pacman_v3-test

   # Train the model
   yzlite train keyword_spotting_pacman_v3

   # Evaluate the trained model .tflite model
   yzlite evaluate keyword_spotting_pacman_v3 --tflite

   # Profile the model in the MVP hardware accelerator simulator
   yzlite profile keyword_spotting_pacman_v3 --accelerator MVP --estimates

   # Profile the model on a physical development board
   yzlite profile keyword_spotting_pacman_v3  --accelerator MVP --device

   # Run the model in the audio classifier on the local PC
   yzlite classify_audio keyword_spotting_pacman_v3 --verbose

   # Run the model in the audio classifier on the physical device
   yzlite classify_audio keyword_spotting_pacman_v3 --device --verbose --accelerator MVP


Model Specification
---------------------

..  literalinclude:: ../../../../../../../yzlite/models/yizhutech/keyword_spotting_pacman_v3.py
    :language: python
    :lines: 590-
...
from yzlite.datasets import audio as audio_datasets
...
class MyModel(
    ...
    # This allows for posting model info to https://wandb.ai
...
# A 1s buffer should be enough to capture the keywords
            ...
            audio_augmentations = audiomentations.Compose(
                ...
                transforms=[
                    audiomentations.Gain(
                        min_gain_in_db=0.95, max_gain_in_db=1.2, p=1.0),
...
class MyDataset(yzlite_core.YZLiteDataset):
    ...
    def load_subset(self, subset: str, test: bool) -> tf.data.Dataset:
        ...
        audio_datasets.direction_commands.download(
            dataset_dir, clean_dest_dir=True)
        ...
        audio_datasets.speech_commands_v2.load_clean_data(
            dataset_dir, clean_dest_dir=False)

        # Download the mlcommons subset and extract into the dataset sub-directory: '_unknown/mlcommons_keywords'
        audio_datasets.mlcommons.ml_commons_keywords.download(
            f'{dataset_dir}/_unknown/mlcommons_keywords')

        # Download the mlcommons ESC-50 dataset and extract into the dataset sub-directory: '_unknown/esc-50'
        audio_datasets.background_noise.esc50.download(
            f'{dataset_dir}/_unknown/esc-50')
        ...
        audio_datasets.utils.download_and_extract(
            ...
            urls=(
                'https://github.com/chenxingqiang/yzlite_assets/raw/master/datasets/recorded_pacman_game_play.7z',
        ...
        audio_datasets.background_noise.brd2601.download(
            f'{dataset_dir}/_background_noise_/brd2601')
        ...
        if subset:
            ...
            features_ds = features_ds.zip(
                (features_ds, labels_ds, seed_counter))
        ...
        **kwargs
        ...
        for kw in os.listdir(mlcommons_keywords_dir):
            ...
            for fn in os.listdir(d):
                if fn.endswith('.wav'):
                    all_keywords.append(
                        f'_unknown/mlcommons_keywords/{kw}/{fn}')
...
my_model.model_parameters['detection_threshold_list'] = list(
    map(lambda x: int(x*255), [.85, .85, .92, .92, .99, .99, 1.0]))
...
if __name__ == '__main__':
    ...
    # Train the model
    # This does the same as issuing the command:  yzlite train keyword_spotting_pacman_v3-test --clean)
    train_results = yzlite_core.train_model(
        my_model, clean=True, test=test_mode_enabled)
    print(train_results)

    # Evaluate the model against the quantized .h5 (i.e. float32) model
    # This does the same as issuing the command: yzlite evaluate keyword_spotting_pacman_v3-test
    tflite_eval_results = yzlite_core.evaluate_model(
        my_model, verbose=True, test=test_mode_enabled)
    print(tflite_eval_results)

    # Profile the model in the simulator
    # This does the same as issuing the command: yzlite profile keyword_spotting_pacman_v3-test
