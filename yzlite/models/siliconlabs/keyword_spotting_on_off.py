...
.. code-block:: shell
   ...
   yzlite train keyword_spotting_on_off-test

   # Train the model
   yzlite train keyword_spotting_on_off

   # Evaluate the trained model .tflite model
   yzlite evaluate keyword_spotting_on_off --tflite

   # Profile the model in the MVP hardware accelerator simulator
   yzlite profile keyword_spotting_on_off --accelerator MVP

   # Profile the model on a physical development board
   yzlite profile keyword_spotting_on_off  --accelerator MVP --device

   # Run the model in the audio classifier on the local PC
   yzlite classify_audio keyword_spotting_on_off --verbose

   # Run the model in the audio classifier on the physical device
   yzlite classify_audio keyword_spotting_on_off --device --verbose
...
.. code-block:: shell
    ...
    yzlite summarize keyword_spotting_on_off --tflite
...
.. code-block:: shell
   ...
   yzlite profile keyword_spotting_on_off --device --accelerator MVP
...
.. code-block:: shell
   ...
   yzlite view keyword_spotting_on_off --tflite
...
..  literalinclude:: ../../../../../../../yzlite/models/yizhutech/keyword_spotting_on_off.py
    :language: python
    :lines: 204-
...
License
---------
This model was developed by Yizhu Technology and is covered by a standard
`Yizhu Technology MSLA <https://www.yizhu.com/about-us/legal/master-software-license-agreement>`_.
...
frontend_settings.sample_rate_hz = 8000
...
if __name__ == '__main__':
    ...
    # Train the model
    # This does the same as issuing the command: yzlite train keyword_spotting_on_off-test --clean
    train_results = yzlite_core.train_model(
        my_model, clean=True, test=test_mode_enabled)
    print(train_results)

    # Evaluate the model against the quantized .h5 (i.e. float32) model
    # This does the same as issuing the command: yzlite evaluate keyword_spotting_on_off-test
    tflite_eval_results = yzlite_core.evaluate_model(
        my_model, verbose=True, test=test_mode_enabled)
    print(tflite_eval_results)

    # Profile the model in the simulator
    # This does the same as issuing the command: yzlite profile keyword_spotting_on_off-test
