...
- Source code: `keyword_spotting_with_transfer_learning.py <https://github.com/chenxingqiang/yzlite/blob/master/yzlite/models/yizhutech/keyword_spotting_with_transfer_learning.py>`_
- Pre-trained model: `keyword_spotting_with_transfer_learning.yzlite.zip <https://github.com/chenxingqiang/yzlite/blob/master/yzlite/models/yizhutech/keyword_spotting_with_transfer_learning.yzlite.zip>`_


This model specification script is designed to work with the
`Keyword Spotting with Transfer Learning <https://github.com/chenxingqiang/yzlite/yzlite/tutorials/keyword_spotting_with_transfer_learning.html>`_ tutorial.

This model uses the weights from the previously trained model `keyword_spotting_mobilenetv2.py <https://github.com/chenxingqiang/yzlite/blob/master/yzlite/models/yizhutech/keyword_spotting_mobilenetv2.py>`_,
...
Preprocessing
--------------
This uses the :py:class:`yzlite.core.preprocess.audio.parallel_generator.ParallelAudioDataGenerator` with the
...
.. code-block:: shell
   ...
   yzlite train keyword_spotting_with_transfer_learning-test

   # Train the model
   yzlite train keyword_spotting_with_transfer_learning

   # Evaluate the trained model .tflite model
   yzlite evaluate keyword_spotting_with_transfer_learning --tflite

   # Profile the model in the MVP hardware accelerator simulator
   yzlite profile keyword_spotting_with_transfer_learning --accelerator MVP

   # Profile the model on a physical development board
   yzlite profile keyword_spotting_with_transfer_learning --accelerator MVP --device

   # Run the model in the audio classifier on the local PC
   yzlite classify_audio keyword_spotting_with_transfer_learning --verbose

   # Run the model in the audio classifier on the physical device
   yzlite classify_audio keyword_spotting_with_transfer_learning --device --verbose
...
.. code-block:: shell
    ...
    yzlite summarize keyword_spotting_with_transfer_learning --tflite
...
.. code-block:: shell
   ...
   yzlite profile keyword_spotting_with_transfer_learning --device --accelerator MVP
...
.. code-block:: shell
   ...
   yzlite view keyword_spotting_with_transfer_learning --tflite
...
..  literalinclude:: ../../../../../../../yzlite/models/yizhutech/keyword_spotting_with_transfer_learning.py
    :language: python
    :lines: 455-
...
# Import the YZLITE model object
# and necessary mixins
# Later in this script we configure the various properties
from yzlite.core import (AudioDatasetMixin, EvaluateClassifierMixin,
                         TrainMixin, YZLiteModel, load_yzlite_model)
...
from yzlite.core.preprocess.audio.parallel_generator import (
    ParallelAudioDataGenerator, ParallelProcessParams)
...
from yzlite.models.shared import MobileNetV2
...
my_model.classes = ['one', 'two', 'three', 'four', 'five',
                    'six', 'seven', 'eight', 'nine', '_unknown_', '_silence_']
...
# Best to key this a power of 2 to aid the FFT
frontend_settings.window_size_ms = 30
frontend_settings.window_step_ms = 20
frontend_settings.filterbank_n_channels = 49
frontend_settings.filterbank_upper_band_limit = 4000.0 - \
    1  # Spoken language usually only goes up to 4k
...
# See the command: "yzlite view_audio"
...
my_model.datagen = ParallelAudioDataGenerator(
    ...
    # debug=True,
    # cores=1,
    # Adjust this as necessary for your PC setup (smaller -> less RAM)
    ...
    rescale=None,
    # Increasing this may help model robustness at the expense of training time
    ...
    # This is a directory provided by the google speech commands dataset, can also provide an absolute path
...
def my_model_builder(model: MyModel):
    ...
    base_yzlite_model = load_yzlite_model('keyword_spotting_mobilenetv2')
    ...
    base_model_h5_path = base_yzlite_model.h5_archive_path
...
if __name__ == '__main__':
    ...
    # Train the model
    # This does the same as issuing the command: yzlite train keyword_spotting_with_transfer_learning-test --clean
    train_results = yzlite_core.train_model(
        my_model, clean=True, test=test_mode_enabled)
    print(train_results)

    # Evaluate the model against the quantized .h5 (i.e. float32) model
    # This does the same as issuing the command: yzlite evaluate keyword_spotting_with_transfer_learning-test
    tflite_eval_results = yzlite_core.evaluate_model(
        my_model, verbose=True, test=test_mode_enabled)
    print(tflite_eval_results)

    # Profile the model in the simulator
    # This does the same as issuing the command: yzlite profile keyword_spotting_with_transfer_learning-test
