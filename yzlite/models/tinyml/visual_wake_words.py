...
* Extracted Reference Dataset: `vw_coco2014_96.tar.gz <https://www.yizhu.com/public/files/github/machine_learning/benchmarks/datasets/vw_coco2014_96.tar.gz>`_
...
.. code-block:: shell
   ...
   yzlite train vww_model-test

   # Train the model
   yzlite train vww_model

   # Evaluate the trained model .tflite model
   yzlite evaluate vww_model --tflite

   # Profile the model in the MVP hardware accelerator simulator
   yzlite profile vww_model --accelerator MVP

   # Profile the model on a physical development board
   yzlite profile vww_model --accelerator MVP --device
...
.. code-block:: shell
    ...
    yzlite summarize visual_wake_words --tflite
...
.. code-block:: shell
   ...
   yzlite profile visual_wake_words --device --accelerator MVP
...
.. code-block:: shell
   ...
   yzlite view visual_wake_words --tflite
...
..  literalinclude:: ../../../../../../../yzlite/models/tinyml/visual_wake_words.py
    :language: python
    :lines: 277-
...
from yzlite.models.shared import MobileNetV1
...
# yzlite train visual_wake_words
#
if __name__ == '__main__':
    ...
    # Train the model
    # This does the same as issuing the command: yzlite train visual_wake_words-test --clean
    train_results = yzlite_core.train_model(
        my_model, clean=True, test=test_mode_enabled)
    print(train_results)

    # Evaluate the model against the quantized .h5 (i.e. float32) model
    # This does the same as issuing the command: yzlite evaluate visual_wake_words-test
    tflite_eval_results = yzlite_core.evaluate_model(
        my_model, verbose=True, test=test_mode_enabled)
    print(tflite_eval_results)

    # Profile the model in the simulator
    # This does the same as issuing the command: yzlite profile visual_wake_words-test
