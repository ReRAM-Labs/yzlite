...
.. code-block:: shell
   ...
   yzlite train keyword_spotting-test

   # Train the model
   yzlite train keyword_spotting

   # Evaluate the trained model .tflite model
   yzlite evaluate keyword_spotting --tflite

   # Profile the model in the MVP hardware accelerator simulator
   yzlite profile keyword_spotting --accelerator MVP

   # Profile the model on a physical development board
   yzlite profile keyword_spotting --accelerator MVP --device
...
.. code-block:: shell
    ...
    yzlite summarize keyword_spotting --tflite
...
.. code-block:: shell
   ...
   yzlite profile keyword_spotting --device --accelerator MVP
...
.. code-block:: shell
   ...
   yzlite view keyword_spotting --tflite
...
..  literalinclude:: ../../../../../../../yzlite/models/tinyml/keyword_spotting.py
    :language: python
    :lines: 204-
...
from yzlite.models.shared import DepthwiseSeparableConv2D_ARM
...
my_model.classes = ('yes', 'no', 'up', 'down', 'left', 'right',
                    'on', 'off', 'stop', 'go', 'unknown', '_background_noise_')
...
if __name__ == '__main__':
    ...
    # Train the model
    # This does the same as issuing the command: yzlite train keyword_spotting-test --clean
    train_results = yzlite_core.train_model(
        my_model, clean=True, test=test_mode_enabled)
    print(train_results)

    # Evaluate the model against the quantized .h5 (i.e. float32) model
    # This does the same as issuing the command: yzlite evaluate keyword_spotting-test
    tflite_eval_results = yzlite_core.evaluate_model(
        my_model, verbose=True, test=test_mode_enabled)
    print(tflite_eval_results)

    # Profile the model in the simulator
    # This does the same as issuing the command: yzlite profile keyword_spotting-test
