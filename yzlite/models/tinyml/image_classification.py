...
.. code-block:: shell
   ...
   yzlite train image_classification-test

   # Train the model
   yzlite train image_classification

   # Evaluate the trained model .tflite model
   yzlite evaluate image_classification --tflite

   # Profile the model in the MVP hardware accelerator simulator
   yzlite profile image_classification --accelerator MVP

   # Profile the model on a physical development board
   yzlite profile image_classification --accelerator MVP --device
...
.. code-block:: shell
   ...
   yzlite profile image_classification --device --accelerator MVP
...
..  literalinclude:: ../../../../../../../yzlite/models/tinyml/image_classification.py
    :language: python
    :lines: 202-
...
from yzlite.models.shared import ResNet10V1
...
my_model.classes = ['airplane', 'automobile', 'bird',
...
if __name__ == '__main__':
    ...
    # Train the model
    # This does the same as issuing the command: yzlite train image_classification-test --clean
    train_results = yzlite_core.train_model(
        my_model, clean=True, test=test_mode_enabled)
    print(train_results)

    # Evaluate the model against the quantized .h5 (i.e. float32) model
    # This does the same as issuing the command: yzlite evaluate image_classification-test
    tflite_eval_results = yzlite_core.evaluate_model(
        my_model, verbose=True, test=test_mode_enabled)
    print(tflite_eval_results)

    # Profile the model in the simulator
    # This does the same as issuing the command: yzlite profile image_classification-test
