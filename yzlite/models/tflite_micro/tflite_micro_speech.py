...
.. code-block:: shell
   ...
   # Train the model
   yzlite train tflite_micro_speech

   # Evaluate the trained model .tflite model
   yzlite evaluate tflite_micro_speech --tflite

   # Profile the model in the MVP hardware accelerator simulator
   yzlite profile tflite_micro_speech --accelerator MVP

   # Profile the model on a physical development board
   yzlite profile tflite_micro_speech --accelerator MVP --device
...
.. code-block:: shell
    ...
    yzlite summarize tflite_micro_speech --tflite
...
.. code-block:: shell
   ...
   yzlite profile tflite_micro_speech --device --accelerator MVP
...
.. code-block:: shell
   ...
   yzlite view tflite_micro_speech --tflite
...
..  literalinclude:: ../../../../../../../yzlite/models/tflite_micro/tflite_micro_speech.py
    :language: python
    :lines: 186-
...
from yzlite.core.model import (AudioDatasetMixin, EvaluateClassifierMixin,
...
if __name__ == '__main__':
    ...
    # Train the model
    # This does the same as issuing the command: yzlite train tflite_micro_speech-test --clean
    train_results = yzlite_core.train_model(
        my_model, clean=True, test=test_mode_enabled)
    print(train_results)

    # Evaluate the model against the quantized .h5 (i.e. float32) model
    # This does the same as issuing the command: yzlite evaluate tflite_micro_speech-test
    tflite_eval_results = yzlite_core.evaluate_model(
        my_model, verbose=True, test=test_mode_enabled)
    print(tflite_eval_results)

    # Profile the model in the simulator
    # This does the same as issuing the command: yzlite profile tflite_micro_speech-test
