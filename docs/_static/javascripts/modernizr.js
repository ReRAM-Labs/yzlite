        ...
        12: function (e, t) {
            ...
            ;(function (i, d, p) {
                ...
                function a(e, t) {
                    if ('object' == typeof e) for (var n in e) v(e, n) && a(n, e[n])
                        ...
                        ;(t = 'function' == typeof t ? t() : t),
                            1 === r.length
                                ? (c[r[0]] = t)
                                : (!c[r[0]] || c[r[0]] instanceof Boolean || (c[r[0]] = new Boolean(c[r[0]])),
                                  (c[r[0]][r[1]] = t)),
                            s([(t && !1 !== t ? '' : 'no-') + r.join('-')]),
                            c._trigger(e, t)
                    }
                ...
                function o(e, t, n, r) {
                    ...
                    if (parseInt(n, 10)) for (; n--; ) ((s = m('div')).id = r ? r[n] : u + (n + 1)), f.appendChild(s)
                    return (
                        ...
                        (i = t(f, e)),
                        c.fake
                            ? (c.parentNode.removeChild(c), (S.style.overflow = a), S.offsetHeight)
                ...
                function r(e, t, n, r, o) {
                    ...
                    return y(t, 'string') || y(t, 'undefined')
                        ? (function (e, t, n, r) {
                              ...
                              for (var s, a, l, u, f, c = ['modernizr', 'tspan', 'samp']; !T.style && c.length; )
                                  (s = !0), (T.modElem = m(c.shift())), (T.style = T.modElem.style)
                        ...
                        : (function (e, t, n) {
                              ...
                              for (var o in e)
                                  if (e[o] in t)
                                      return !1 === n ? e[o] : y((r = t[e[o]]), 'function') ? u(r, n || t) : r
                              return !1
                ...
                ;(v =
                    ...
                    c.addTest('json', 'JSON' in i && 'parse' in JSON && 'stringify' in JSON),
                    c.addTest(
                        'svg',
                    ...
                    (function () {
                        ...
                        for (var s in f)
                            if (f.hasOwnProperty(s)) {
                                ...
                                for (r = y(t.fn, 'function') ? t.fn() : t.fn, o = 0; o < e.length; o++)
                                    1 === (i = e[o].split('.')).length
                                        ? (c[i[0]] = r)
                                        : (!c[i[0]] || c[i[0]] instanceof Boolean || (c[i[0]] = new Boolean(c[i[0]])),
                                          (c[i[0]][i[1]] = r)),
                                        g.push((r ? '' : 'no-') + i.join('-'))
                            }
                    })(),
