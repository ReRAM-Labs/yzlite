    ...
    (function (n) {
                    ...
                    Listener: (function () {
                        function e(e, t, n) {
                            ...
                            ;(this.els_ = Array.prototype.slice.call(
                                'string' == typeof e ? document.querySelectorAll(e) : [].concat(e)
                            )),
                                (this.handler_ =
                                    'function' == typeof n
                                        ? {
                ...
                i = {
                    Shadow: (function () {
                        function e(e, t) {
                            ...
                            if (!(n instanceof HTMLElement && n.parentNode instanceof HTMLElement))
                                throw new ReferenceError()
                            if (
                                ((this.el_ = n.parentNode),
                                !((n = 'string' == typeof t ? document.querySelector(t) : t) instanceof HTMLElement))
                            )
                                throw new ReferenceError()
                        ...
                        return (
                            ...
                            (t.update = function (e) {
                                if (!e || ('resize' !== e.type && 'orientationchange' !== e.type)) {
                                    ...
                                    t !== this.active_ &&
                                        (this.header_.dataset.mdState = (this.active_ = t) ? 'shadow' : '')
                    ...
                    Title: (function () {
                        function e(e, t) {
                            ...
                            if (
                                ((this.el_ = n),
                                !(
                                    (n = 'string' == typeof t ? document.querySelector(t) : t) instanceof
                                    HTMLHeadingElement
                                ))
                            )
                                throw new ReferenceError()
                        ...
                        return (
                            ...
                            (t.update = function () {
                                var e = window.pageYOffset,
                                    t = this.offset_ - e < 0
                                if (
                                    (this.dir_ !== t && (this.index_ = this.index_ = t ? 0 : this.els_.length - 1),
                                    0 !== this.anchors_.length)
                                ) {
                                    if (this.offset_ <= e)
                                        for (
                                            var n = this.index_ + 1;
                                            n < this.els_.length && this.anchors_[n].offsetTop - 80 <= e;
                                            n++
                                        )
                                            0 < n && (this.els_[n - 1].dataset.mdState = 'blur'), (this.index_ = n)
                                    else
                    ...
                    Scrolling: (function () {
                        ...
                        return (
                            (t.setup = function () {
                                ...
                                Array.prototype.forEach.call(e, function (e) {
                                    ...
                                    if (e.checked) {
                                        ...
                                        if (!(t instanceof HTMLElement)) throw new ReferenceError()
                                        for (; 'NAV' !== t.tagName && t.nextElementSibling; ) t = t.nextElementSibling
                                        if (
                                            !(
                            ...
                            (t.update = function (e) {
                                ...
                                if (!(n instanceof HTMLElement)) throw new ReferenceError()
                                for (; 'NAV' !== n.tagName && n.nextElementSibling; ) n = n.nextElementSibling
                                if (
                                    !(
                        ...
                        return (
                            ...
                            (t.update = function (e) {
                                ...
                                o !== this.height_ && (this.el_.style.height = (this.height_ = o) + 'px'),
                                    t >= this.offset_
                                        ? 'lock' !== this.el_.dataset.mdState && (this.el_.dataset.mdState = 'lock')
                                        : 'lock' === this.el_.dataset.mdState && (this.el_.dataset.mdState = '')
                            }),
                            (t.reset = function () {
        ...
        function (e, t, n) {
            ...
            function r(e, t) {
                ...
                for (var r = arguments.length, i = new Array(2 < r ? r - 2 : 0), o = 2; o < r; o++)
                    i[o - 2] = arguments[o]
                return (
                    (function t(e) {
                        Array.prototype.forEach.call(e, function (e) {
                                    ...
                                    [
                                        {
                                            ...
                                            value: function () {
                                                ...
                                                ;(this.action =
                                                    ...
                                                    (this.container =
                                                        'object' === i(e.container) ? e.container : document.body)
                                            }
                                        },
                                        {
                                            key: 'listenClick',
        ...
        function (r, i, o) {
            ...
            !(function (e) {
                if (
                    (void 0 === (s = 'function' == typeof (a = e) ? a.call(i, o, i, r) : a) || (r.exports = s),
                    !0,
                    (r.exports = e()),
                    !!0)
                ) {
                        ...
                        if ('undefined' != typeof document) {
                            ...
                            for (
                                ...
                                try {
                                    ...
                                    if (
                                        ((f = h.read ? h.read(f, d) : h(f, d) || f.replace(c, decodeURIComponent)),
                                        this.json)
                                    )
                                        try {
                                            f = JSON.parse(f)
                            ...
                            (e.prototype.update = function (e) {
                                ...
                                if ('focus' !== e.type || this.index_) {
                                    if ('focus' === e.type || 'keyup' === e.type) {
                                        ...
                                        if (((this.value_ = n.value), 0 === this.value_.length))
                                        ...
                                        for (; this.stack_.length && o.offsetHeight >= o.scrollHeight - 16; )
                                            this.stack_.shift()()
                                    ...
                                    var u = function (e) {
                                            ...
                                            (a.index_ = d()(function () {
                                                ...
                                                this.pipeline.reset(),
                                                    ...
                                                    1 === o.length && 'en' !== o[0] && d.a[o[0]]
                                                        ? this.use(d.a[o[0]])
                                                        : 1 < o.length && this.use(d.a.multiLanguage.apply(d.a, o)),
                                                    this.field('title', {
                                                        boost: 10
                                                    }),
                                                    this.field('text'),
                                        ...
                                        t.addEventListener('scroll', function () {
                                            for (
                                                ;
                                                a.stack_.length && t.scrollTop + t.offsetHeight >= t.scrollHeight - 16;
                        ...
                        initialize: function (t) {
                            new i.a.Event.Listener(document, 'DOMContentLoaded', function () {
                                ...
                                if (
                                    ...
                                    Array.prototype.forEach.call(t, function (e, t) {
                                        ...
                                        new a.a('.md-clipboard').on('success', function (e) {
                                            ...
                                            if (!(t instanceof HTMLElement)) throw new ReferenceError()
                                            e.clearSelection(),
                                                t.dataset.mdTimer && clearTimeout(parseInt(t.dataset.mdTimer, 10)),
                                ...
                                if ((window.addEventListener('hashchange', r), r(), Modernizr.ios)) {
                                    ...
                                    Array.prototype.forEach.call(i, function (t) {
                                        t.addEventListener('touchstart', function () {
                                            ...
                                            0 === e
                                                ? (t.scrollTop = 1)
                                                : e + t.offsetHeight === t.scrollHeight && (t.scrollTop = e - 1)
                                        })
                                    })
                                }
                            }).listen(),
                                new i.a.Event.Listener(
                                    ...
                                    new i.a.Header.Shadow('[data-md-component=container]', '[data-md-component=header]')
                                ).listen(),
                                new i.a.Event.Listener(
                                    window,
                                    ['scroll', 'resize', 'orientationchange'],
                                    new i.a.Header.Title('[data-md-component=title]', '.md-typeset h1')
                                ).listen(),
                            ...
                            Array.prototype.forEach.call(e, function (e) {
                                new i.a.Event.MatchMedia(
                                    '(min-width: 1220px)',
                                    new i.a.Event.Listener(e.previousElementSibling, 'click', new i.a.Nav.Collapse(e))
                                )
                            }),
                                new i.a.Event.MatchMedia(
                                    '(max-width: 1219px)',
        ...
        function (e, t) {
            e.exports =
                '/Users/squidfunk/Desktop/General/Sources/mkdocs-material/material/application-palette.224b79ff.css'
        },
        function (e, t) {
            !(function () {
                ...
                ;(D.version = '2.3.6'),
                    ...
                    (D.FieldRef.prototype.toString = function () {
                        return (
                            null == this._stringValue &&
                                (this._stringValue = this.fieldName + D.FieldRef.joiner + this.docRef),
                            this._stringValue
                        )
                    }),
                    (D.Set = function (e) {
                    ...
                    (D.Set.prototype.union = function (e) {
                        return e === D.Set.complete
                            ...
                            : e === D.Set.empty
                            ? this
                            : new D.Set(Object.keys(this.elements).concat(Object.keys(e.elements)))
                    }),
                    (D.idf = function (e, t) {
                        var n = 0
                    ...
                    (D.tokenizer = function (e, t) {
                        ...
                        for (
                            var n = e.toString().trim().toLowerCase(), r = n.length, i = [], o = 0, a = 0;
                            o <= r;
                            o++
                        ) {
                            var s = o - a
                    ...
                    (D.stemmer =
                        ...
                        (e = '[aeiouy]'),
                        (n = '[^aeiou][^aeiouy]*'),
                        (f = new RegExp('^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*')),
                        (d = new RegExp(
                        ...
                        (r = function (e) {
                            ...
                            if (
                                ('y' == (r = e.substr(0, 1)) && (e = r.toUpperCase() + e.substr(1)),
                                (o = y),
                                (i = m).test(e) ? (e = e.replace(i, '$1$2')) : o.test(e) && (e = e.replace(o, '$1$2')),
                                (o = g),
                                (i = v).test(e))
                            ) {
                                var c = i.exec(e)
                            ...
                            ;(i = k).test(e) &&
                                ((t = (c = i.exec(e))[1]), (n = c[2]), (i = f).test(t) && (e = t + l[n]))
                            ;(i = S).test(e) &&
                                ((t = (c = i.exec(e))[1]), (n = c[2]), (i = f).test(t) && (e = t + u[n]))
                            ...
                            return (
                                (o = d),
                                (i = O).test(e) && o.test(e) && ((i = w), (e = e.replace(i, ''))),
                    ...
                    (D.TokenSet.prototype.toString = function () {
                        ...
                        for (
                            var e = this.final ? '1' : '0', t = Object.keys(this.edges).sort(), n = t.length, r = 0;
                            r < n;
                            r++
                        ) {
                            var i = t[r]
                                ...
                                for (var l = i[c], u = 0; u < s; u++) {
                                    ...
                                    if (f == l || '*' == l) {
                                        ...
                                        f in n.output.edges
                                            ...
                                            : (((m = new D.TokenSet()).final = p), (n.output.edges[f] = m)),
                                            r.push({
                                                qNode: h,
                                                output: m,
                                                node: d
                    ...
                    (D.TokenSet.Builder.prototype.insert = function (e) {
                        ...
                        for (
                            var r = 0;
                            r < e.length && r < this.previousWord.length && e[r] == this.previousWord[r];
                            r++
                        )
                            n++
                        this.minimize(n),
                    ...
                    (D.Index.prototype.query = function (e) {
                        ...
                        for (s = 0; s < t.clauses.length; s++) {
                            var c = t.clauses[s],
                                ...
                                u = D.Set.complete
                            l = c.usePipeline
                                ? this.pipeline.runString(c.term, {
                                      fields: c.fields
                                  })
                                : [c.term]
                                    ...
                                    for (m = 0; m < c.fields.length; m++) {
                                        ...
                                        if (
                                            (c.presence == D.Query.presence.REQUIRED &&
                                                ((u = u.union(b)), void 0 === o[Q] && (o[Q] = D.Set.complete)),
                            ...
                            for (var d = 0; d < l.length; d++) {
                                ...
                                for (var y = 0; y < this.metadataWhitelist.length; y++) {
                                    var v = this.metadataWhitelist[y],
                                        g = h.metadata[v]
                                    null == this.invertedIndex[h][o][n][v] && (this.invertedIndex[h][o][n][v] = []),
                    ...
                    (D.Builder.prototype.createFieldVectors = function () {
                        for (
                            ...
                            for (
                                ...
                                void 0 === r[g]
                                    ? ((m = D.idf(this.invertedIndex[g], this.documentCount)), (r[g] = m))
                                    : (m = r[g]),
                                    (y =
                                        (m * ((this._k1 + 1) * w)) /
                                        (this._k1 * (1 - this._b + this._b * (s / this.averageFieldLength[a])) + w)),
                                    (y *= d),
                                    (y *= h),
                    ...
                    (D.MatchData = function (e, t, n) {
                        ...
                        ;(this.metadata = Object.create(null)),
                            void 0 !== e && ((this.metadata[e] = Object.create(null)), (this.metadata[e][t] = r))
                    }),
                            ...
                            for (var o = 0; o < i.length; o++) {
                                ...
                                for (var c = 0; c < s.length; c++) {
                                    ...
                                    null == this.metadata[r][a][l]
                                        ...
                                        : (this.metadata[r][a][l] = this.metadata[r][a][l].concat(e.metadata[r][a][l]))
                                }
                            }
                        }
                    }),
                    ...
                    (D.QueryLexer.prototype.sliceString = function () {
                        for (var e = [], t = this.start, n = this.pos, r = 0; r < this.escapeCharPositions.length; r++)
                            (n = this.escapeCharPositions[r]), e.push(this.str.slice(t, n)), (t = n + 1)
                    ...
                    (D.QueryLexer.lexTerm = function (e) {
                        if ((1 < e.width() && (e.backup(), e.emit(D.QueryLexer.TERM)), e.ignore(), e.more()))
                    ...
                    (D.QueryLexer.lexText = function (e) {
                        for (;;) {
                            ...
                            if (92 != t.charCodeAt(0)) {
                                ...
                                if ('^' == t)
                                    return e.backup(), 0 < e.width() && e.emit(D.QueryLexer.TERM), D.QueryLexer.lexBoost
                                if ('+' == t && 1 === e.width())
