                ...
                return {
                    ...
                    in_grouping: function (r, t, i) {
                        if (this.cursor < this.limit) {
                            ...
                            if (s <= i && t <= s && r[(s -= t) >> 3] & (1 << (7 & s))) return this.cursor++, !0
                        }
                        return !1
                    },
                    ...
                    out_grouping: function (r, t, i) {
                        if (this.cursor < this.limit) {
                            ...
                            if (!(r[(s -= t) >> 3] & (1 << (7 & s)))) return this.cursor++, !0
                        }
                        return !1
                    },
                    ...
                    eq_s: function (r, t) {
                        ...
                        for (var i = 0; i < r; i++) if (b.charCodeAt(this.cursor + i) != t.charCodeAt(i)) return !1
                        return (this.cursor += r), !0
                    },
                    eq_s_b: function (r, t) {
                        if (this.cursor - this.limit_backward < r) return !1
                        for (var i = 0; i < r; i++) if (b.charCodeAt(this.cursor - r + i) != t.charCodeAt(i)) return !1
                        return (this.cursor -= r), !0
                    },
                    find_among: function (r, t) {
                        for (var i = 0, s = t, e = this.cursor, n = this.limit, u = 0, o = 0, h = !1; ; ) {
                            for (
                                var c = i + ((s - i) >> 1), a = 0, f = u < o ? u : o, l = r[c], _ = f;
                                _ < l.s_size;
                                _++
                            ) {
                                if (e + f == n) {
                    ...
                    find_among_b: function (r, t) {
                        for (var i = 0, s = t, e = this.cursor, n = this.limit_backward, u = 0, o = 0, h = !1; ; ) {
                            for (
                                var c = i + ((s - i) >> 1), a = 0, f = u < o ? u : o, l = (_ = r[c]).s_size - 1 - f;
                                0 <= l;
                                l--
                            ) {
                                if (e - f == n) {
                    ...
                    replace_s: function (r, t, i) {
                        ...
                        return (
                            ...
                            (this.limit += s),
                            this.cursor >= t ? (this.cursor += s) : this.cursor > r && (this.cursor = r),
                            s
                        )
                    },
                    slice_check: function () {
                        if (this.bra < 0 || this.bra > this.ket || this.ket > this.limit || this.limit > b.length)
