                                    ...
                                    if (h.cursor >= o)
                                        if (
                                            ...
                                            switch (((h.bra = h.cursor), (h.limit_backward = e), i)) {
                                                case 1:
                                                    ;(r = h.limit - h.cursor),
                                                        h.eq_s_b(1, 'k') || ((h.cursor = h.limit - r), h.slice_del())
                                                    break
                                                case 2:
                                                    h.slice_del(),
                                                        (h.ket = h.cursor),
                                                        h.eq_s_b(3, 'kse') && ((h.bra = h.cursor), h.slice_from('ksi'))
                                                    break
                                                case 3:
                                                    h.slice_del()
                                                    break
                                        ...
                                        if (
                                            ...
                                            switch (((h.bra = h.cursor), (h.limit_backward = e), i)) {
                                                ...
                                                case 7:
                                                    if (
                                                        ((r = h.limit - h.cursor),
                                                        !j() && ((h.cursor = h.limit - r), !h.eq_s_b(2, 'ie')))
                                                    ) {
                                                        h.cursor = h.limit - r
                                                        break
                                                    }
                                                    if (((h.cursor = h.limit - r), h.cursor <= h.limit_backward)) {
                                                        h.cursor = h.limit - r
                                                        break
                                                    }
                                                    ...
                                                    break
                                                case 8:
                                                    if (!h.in_grouping_b(d, 97, 246) || !h.out_grouping_b(d, 97, 246))
                                                        return
                                            }
                                            h.slice_del(), (n = !0)
                                        } else h.limit_backward = e
                                ...
                                (function () {
                                    ...
                                    if (h.cursor >= l)
                                        if (
                                            ...
                                            if (((h.bra = h.cursor), (h.limit_backward = e), 1 == i)) {
                                                if (((r = h.limit - h.cursor), h.eq_s_b(2, 'po'))) return
                                                h.cursor = h.limit - r
                                            }
                                            h.slice_del()
                                        } else h.limit_backward = e
                                ...
                                (h.cursor =
                                    (n
                                        ? h.cursor >= o &&
                                          ...
                                          (h.ket = h.cursor),
                                          h.find_among_b(_, 2)
                                              ? ((h.bra = h.cursor), (h.limit_backward = i), h.slice_del())
                                              : (h.limit_backward = i))
                                        : ((h.cursor = h.limit),
                                          (function () {
                                              var i, e, r, n, t, s
                                              if (h.cursor >= o) {
                                                  if (
                                                      ...
                                                      if (((h.bra = h.cursor), (h.limit_backward = t), 1 == i)) {
                                                          if (((s = h.limit - h.cursor), h.eq_s_b(2, 'po'))) return
                                                          h.cursor = h.limit - s
                                                      }
                                                      return h.slice_del()
                                                  }
                                        ...
                                        for (
                                            i = h.limit_backward,
                                                ...
                                                h.in_grouping_b(b, 97, 228) &&
                                                    ((h.bra = h.cursor), h.out_grouping_b(d, 97, 246) && h.slice_del()),
                                                h.cursor = h.limit - e,
                                                h.ket = h.cursor,
                                                h.eq_s_b(1, 'j') &&
                                                    ((h.bra = h.cursor),
                                                ...
                                                h.ket = h.cursor,
                                                h.eq_s_b(1, 'o') &&
                                                    ((h.bra = h.cursor), h.eq_s_b(1, 'j') && h.slice_del()),
                                                h.cursor = h.limit - e,
                                                h.limit_backward = i;
                                            ;

                                        ) {
                                            if (((n = h.limit - h.cursor), h.out_grouping_b(d, 97, 246))) {
                                                h.cursor = h.limit - n
                                                break
                                            }
                                            if (((h.cursor = h.limit - n), h.cursor <= h.limit_backward)) return
                                            h.cursor--
                                        }
                                        ;(h.ket = h.cursor),
                                            h.cursor > h.limit_backward &&
