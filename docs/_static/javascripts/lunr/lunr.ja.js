!(function (e, r) {
    ...
    return function (m) {
        if (void 0 === m) throw new Error('Lunr is not present. Please include / require Lunr before this script.')
        ...
        ;(m.ja.tokenizer = function (e) {
            ...
            for (r = (t = e.toString().toLowerCase().replace(/^\s+/, '')).length - 1; 0 <= r; r--)
                ...
                if (((s = a - p), t.charAt(a).match(/\s/) || a == i)) {
                    if (0 < s)
                        for (
                            ...
                            l
                                ? o.push(new m.Token(n[r], { position: [u, n[r].length], index: o.length }))
                                : o.push(n[r]),
                                (u += n[r].length)
                    p = a + 1
                }
