            ...
            (e.da.stemmer =
                ...
                (i = new (function () {
                    var i,
                        ...
                        o = [new r('gd', -1, -1), new r('dt', -1, -1), new r('gt', -1, -1), new r('kt', -1, -1)],
                        a = [
                            new r('ig', -1, 1),
                            new r('lig', 0, 1),
                            new r('elig', 1, 1),
                        ...
                        (this.stem = function () {
                            ...
                            return (
                                ...
                                (function () {
                                    ...
                                    if (
                                        ((c.ket = c.cursor),
                                        c.eq_s_b(2, 'st') && ((c.bra = c.cursor), c.eq_s_b(2, 'ig') && c.slice_del()),
                                        (c.cursor = c.limit - n),
                                        c.cursor >= t &&
                                            ((r = c.limit_backward),
                                            (c.limit_backward = t),
                                        ...
                                        switch (((c.bra = c.cursor), e)) {
                                            case 1:
                                                c.slice_del(), (i = c.limit - c.cursor), l(), (c.cursor = c.limit - i)
                                                break
                                            case 2:
                                                c.slice_from('løs')
                                        }
