            ...
            (e.ru.stemmer =
                ...
                (n = new (function () {
                    var n,
                        ...
                        c = [new h('ейше', -1, 1), new h('н', -1, 2), new h('ейш', -1, 1), new h('ь', -1, 3)],
                        m = [33, 65, 8, 232],
                        l = new g()
                    function f() {
                        ...
                        if (((l.ket = l.cursor), (r = l.find_among_b(e, n)))) {
                            switch (((l.bra = l.cursor), r)) {
                                case 1:
                                    if (
                                        ((t = l.limit - l.cursor),
                                        !l.eq_s_b(1, 'а') && ((l.cursor = l.limit - t), !l.eq_s_b(1, 'я')))
                                    )
                                        return !1
                                case 2:
                                    l.slice_del()
                    ...
                    function d(e, n) {
                        ...
                        return (
                            (l.ket = l.cursor),
                            !!(r = l.find_among_b(e, n)) && ((l.bra = l.cursor), 1 == r && l.slice_del(), !0)
                        )
                    }
                    function _() {
                    ...
                    function b() {
                        var e
                        ;(l.ket = l.cursor),
                            (e = l.find_among_b(o, 2)) && ((l.bra = l.cursor), n <= l.cursor && 1 == e && l.slice_del())
                    }
                            ...
                            return (
                                ...
                                !(l.cursor < e) &&
                                    ...
                                    p(r, 9) ||
                                        ...
                                        _() || ((l.cursor = l.limit), p(u, 46) || ((l.cursor = l.limit), d(s, 36)))),
                                    (l.cursor = l.limit),
                                    (l.ket = l.cursor),
                                    l.eq_s_b(1, 'и') ? ((l.bra = l.cursor), l.slice_del()) : (l.cursor = l.limit),
                                    b(),
                                    (l.cursor = l.limit),
                                    (function () {
                                        var e
                                        if (((l.ket = l.cursor), (e = l.find_among_b(c, 4))))
                                            switch (((l.bra = l.cursor), e)) {
                                                case 1:
                                                    if ((l.slice_del(), (l.ket = l.cursor), !l.eq_s_b(1, 'н'))) break
                                                    l.bra = l.cursor
                                                case 2:
