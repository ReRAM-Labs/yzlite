!(function (e, i) {
    ...
    return function (o) {
        o.multiLanguage = function () {
            for (
                var e = Array.prototype.slice.call(arguments), i = e.join('-'), t = '', r = [], n = [], s = 0;
                s < e.length;
                ++s
            )
                'en' == e[s]
                    ? ((t += '\\w'), r.unshift(o.stopWordFilter), r.push(o.stemmer), n.push(o.stemmer))
            ...
            return (
                ...
                function () {
                    this.pipeline.reset(),
                        ...
                        this.searchPipeline &&
                            (this.searchPipeline.reset(), this.searchPipeline.add.apply(this.searchPipeline, n))
                }
            )
        }
    }
