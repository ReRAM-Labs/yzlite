            ...
            (e.pt.stemmer =
                ...
                (r = new (function () {
                    var s,
                        ...
                        r = [new j('ic', -1, -1), new j('ad', -1, -1), new j('os', -1, -1), new j('iv', -1, 1)],
                        t = [new j('ante', -1, 1), new j('avel', -1, 1), new j('ível', -1, 1)],
                        ...
                        l = [new j('e', -1, 1), new j('ç', -1, 2), new j('é', -1, 1), new j('ê', -1, 1)],
                    ...
                    function p() {
                        ...
                        if (((d.cursor = s), d.out_grouping(f, 97, 250))) {
                            if (((r = d.cursor), v())) {
                                if (((d.cursor = r), !d.in_grouping(f, 97, 250) || d.cursor >= d.limit)) return
                                d.cursor++
                            }
                            i = d.cursor
                        }
                                ...
                                d.slice_del(),
                                    ...
                                    (e = d.find_among_b(r, 4)) &&
                                        ...
                                        b() &&
                                            ...
                                            1 == e &&
                                                ((d.ket = d.cursor),
                                                d.eq_s_b(2, 'at') && ((d.bra = d.cursor), b() && d.slice_del()))))
                                break
                            case 6:
                                if (!b()) return !1
                                d.slice_del(),
                                    (d.ket = d.cursor),
                                    (e = d.find_among_b(t, 3)) && ((d.bra = d.cursor), 1 == e && b() && d.slice_del())
                                break
                            case 7:
                                if (!b()) return !1
                                d.slice_del(),
                                    (d.ket = d.cursor),
                                    (e = d.find_among_b(u, 3)) && ((d.bra = d.cursor), 1 == e && b() && d.slice_del())
                                break
                            case 8:
                                if (!b()) return !1
                                d.slice_del(),
                    ...
                    function k(e, r) {
                        if (d.eq_s_b(1, e)) {
                            ...
                            if (d.eq_s_b(1, r)) return (d.cursor = d.limit - s), h() && d.slice_del(), !1
                        }
                        return !0
                    }
                    function q() {
                        if (
                            ...
                            !(function () {
                                ...
                                if (d.cursor >= i) {
                                    if (
                                        ...
                                        return (d.bra = d.cursor), 1 == e && d.slice_del(), (d.limit_backward = r), !0
                                    d.limit_backward = r
                                }
                                return !1
                            })())
                            ...
                            return (
                                ...
                                (d.ket = d.cursor),
                                void (
                                    (e = d.find_among_b(c, 7)) && ((d.bra = d.cursor), 1 == e && h() && d.slice_del())
                                )
                            )
                        var e
                        ;(d.cursor = d.limit),
                            (d.ket = d.cursor),
                            d.eq_s_b(1, 'i') &&
                                ((d.bra = d.cursor), d.eq_s_b(1, 'c') && ((d.cursor = d.limit), h() && d.slice_del()))
                    }
