...
$(function () {
    ...
    if (props && !window._added_props) {
        ...
        var s =
            '<li class="md-nav__item"><label class="md-nav__title" style="padding-top:30px">Properties</label>' +
            '<nav class="md-nav"><ul class="md-nav__list">'
        props.each((index) => {
            var element = props[index]
            s += `<li class="md-nav__item"><a href="${getHref(element)}" class="md-nav__link">${getTitle(
                element
            )}</a></li>`
        })
        s += '</ul></nav></li>'
    ...
    if (methods && !window._added_methods) {
        ...
        var s =
            '<li class="md-nav__item"><label class="md-nav__title" style="padding-top:30px">Methods</label>' +
            '<nav class="md-nav"><ul class="md-nav__list">'
        methods.each((index) => {
    ...
    if (variables && !window._added_variables) {
        ...
        var s =
            '<li class="md-nav__item"><label class="md-nav__title" style="padding-top:30px">Variables</label>' +
            '<nav class="md-nav"><ul class="md-nav__list">'
    ...
    if (funcs && !window._added_funcs) {
        ...
        var s =
            '<li class="md-nav__item"><label class="md-nav__title" style="padding-top:30px">Functions</label>' +
            '<nav class="md-nav"><ul class="md-nav__list">'
        funcs.each((index) => {
    ...
    if (
        !window._remove_toc &&
        (window._added_props || window._added_methods || window._added_variables || window._added_funcs)
    ) {
